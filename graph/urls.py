...
urlpatterns = patterns('',
   # (r'', include('graph.apps.')),
    ...
    url(r'^api/nb/$', 'graph.apps.api.views.notebook_list', name="notebook-list"),
    url(r'^api/nb/(?P<notebook>\w+)/$', 'graph.apps.api.views.notebook_var_list', name="notebook-var-list"),
